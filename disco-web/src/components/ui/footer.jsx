    ...
    <div className="w-full px-[4%] bg-blackD items-center justify-center py-8">
      <div className="w-full flex flex-col lg:flex-row items-center lg:justify-between justify-center">
        ...
        <div className="flex gap-4 mt-5 lg:mt-0">
          ...
          <a href="https://www.instagram.com/rotaractdistrict.3220/" className='border border-white text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-white hover:text-cranberry'><Instagram size={20} /></a>
      ...
      <div className="w-full flex flex-col lg:flex-row items-center lg:justify-between mt-5">
        <p className='text-white text-sm'>© 2026 Rotaract in RID 3220. All rights reserved.</p>
        <p className="text-xs md:text-sm text-white">
          Designed & Developed by <span className='animate-gradient font-bold bg-gradient-to-r bg-clip-text text-transparent from-[#22D1AE] via-[#EAEAEA] to-[#22D1AE]'><a href="https://sandinupinnawala.com/">Code.Techghost</a></span>
        </p>
      </div>
