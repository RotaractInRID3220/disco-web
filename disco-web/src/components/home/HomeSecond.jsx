...
const HomeSecond = () => {
  return (
    <div className='flex flex-col text-center items-center justify-center mt-5'>
      ...
      <p className='text-lg w-2/3 leading-6 mt-8'>Rotaract, under Rotary International, was introduced to RID 3220 in 1969. Since then, it has become one of the most dynamic youth-led networks in the region. As part of a global network spanning 180 countries and over 10,600 clubs, Rotaract in RID 3220 brings international collaboration and local action together to make a meaningful impact. We focus on:</p>
