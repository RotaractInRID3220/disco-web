...
const HomeSixth = () => {
  return (
    <div className='grid grid-cols-2 mt-30'>
      <a href="">
        <div className='bg-cranberry hover:bg-white transition-all border-2 border-cranberry  py-16 items-center justify-center flex group relative'>
      ...
      <a href="">
        <div className='bg-white hover:bg-cranberry transition-all border-2 border-cranberry  py-16 items-center justify-center flex group relative'>
