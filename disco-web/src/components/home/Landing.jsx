        ...
        <div className='flex flex-col text-center items-center justify-center lg:mt-[11%] mt-[25%]'>
          ...
          <div className='lg:grid hidden grid-cols-6 gap-5 items-end -translate-y-28 mb-0'>
            <div className='flex flex-col gap-5'>
              ...
              <div className='py-4 border-2 border-blackD rounded-2xl max-h-32'>
                <CountUp to={96} from={20} direction="up" delay={0} duration={2} className="text-7xl font-bebas text-blackD" />
                <h1 className='text-blackD text-3xl -mt-3'>clubs</h1>
              </div>
            </div>
            <img src="/i4.png" alt="" loading="lazy" />
            <img src="/i3.png" className='col-span-2' alt="" loading="lazy" />
            <img src="/i5.png" alt="" loading="lazy" />
            <div className='flex flex-col gap-5'>
              <img src="/i2.png" alt="" loading="lazy" />
              <div className='py-4 border-2 border-blackD rounded-2xl max-h-32'>
                <CountUp to={4920} from={2500} direction="up" delay={0} duration={2} className="text-7xl font-bebas text-blackD" />
          ...
          <div className='flex lg:hidden mt-5 flex-col gap-5 items-end mb-0'>
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className='flex flex-col gap-5'>
                <div className='py-4 border-2 border-blackD rounded-2xl max-h-24'>
                  <CountUp to={4130} from={2500} direction="up" delay={0} duration={2} className="text-5xl font-bebas text-blackD" />
                  <h1 className='text-blackD text-2xl -mt-3'>rotaractors</h1>
                </div>
                <img src="/i2.png" alt="" />
              </div>
