      ...
      <div className='grid grid-cols-6 gap-5 items-end -translate-y-28 mb-0'>
        <div className='flex flex-col gap-5'>
            ...
            <div className='py-4 border-2 border-blackD rounded-2xl max-h-32'>
                <CountUp to={85} from={0} direction="up" delay={0} duration={2} className="text-7xl font-bebas text-blackD" />
        ...
        <div className='flex flex-col gap-5'>
            <img src="/l2.svg" alt="" />
            <div className='py-4 border-2 border-blackD rounded-2xl max-h-32'>
                <CountUp to={2850} from={0} direction="up" delay={0} duration={2} className="text-7xl font-bebas text-blackD" />
