    ...
    <div className='mt-20 lg:px-20 px-8 mb-20 lg:mb-0' id='about3'>
      ...
      <div className='flex flex-col lg:flex-row items-center justify-center lg:gap-10 gap-5 lg:h-dvh ping-section bg-white' id='#Naz'>
        ...
        <div className='lg:px-10 text-center lg:text-left' >
          ...
          <h1 className="lg:text-4xl text-3xl text-cranberry font-bebas tracking-wide mt-8">Rtr. PP NAZMI MAHAMOOD</h1>
          <h1 className="lg:text-2xl text-xl text-cranberry/70 font-bebas tracking-wide -mt-2">District Rotaract Representative 2025-26</h1>
        </div>
      </div>
      ...
      <div className='flex flex-col lg:flex-row items-center justify-center lg:gap-10 gap-5 lg:h-dvh ping-section bg-white mt-20 lg:mt-0' id='#Naz'>
        ...
        <div className='lg:px-10 text-center lg:text-left' >
          ...
          <p className=" font-poppins leading-relaxed text-justify">
            ...
            Congratulations on your appointments as change-makers for Rotaract in Sri Lanka and the Maldives for the term 2026-27. It’s an honour to begin this exciting chapter with a team of dynamic individuals who embody compassion, creativity, and a deep commitment to service. <br /><br />
