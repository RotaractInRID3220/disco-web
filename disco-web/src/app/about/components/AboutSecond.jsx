...
const AboutSecond = () => {
  return (
    <div className="mt-30 px-20 text-center">
        <h1 className='text-5xl font-bebas text-cranberry tracking-wide'>We Are</h1>
        <div className='flex items-center justify-center h-76 mt-7 gap-10 px-10'>
