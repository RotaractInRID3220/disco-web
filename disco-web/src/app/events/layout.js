export const metadata = {
  ...
  keywords: [
    ...
    "Rotaract calendar",
    "run for change",
    "run for change sri lanka",
    "run for change registration",
    "rotaract charity run",
    "charity run sri lanka",
    "run for change colombo",
    "youth charity run sri lanka",
    "carnage sri lanka run",
    "community service",
    "youth service",
    "fitness events sri lanka",
    "sports events sri lanka",
    "social impact",
    "volunteering",
    "rotaract rid 3220",
    "run for change fundraising"
  ],
